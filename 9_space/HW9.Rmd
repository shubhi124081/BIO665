...
The DIC from gjam model is 1376370, which is bigger than the DIC of the spatial model. It appears that the spatial model can better explain the data in this case. One weird thing we noticed is that we got a few different DIC from running the same gjam model. 
