...
From the observed and predicted graph the spatial random effects model does very well in terms of prediction. From the mean and spatial random effects surfaces, it appears that the spatial random effects do in fact explain alot of the variation. 
