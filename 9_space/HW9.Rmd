...
pacman::p_load(CARBayes, CARBayesdata, classInt, coda, fields, geomapdata, geoR, gjam, knitr, lattice, mapdata, maps, maptools, MASS, MBA, plyr, RANN, RColorBrewer, reshape2, rgdal, sp, spBayes, spdep)
...
y <- rbinom(length(phi), size, prob=p)

binomialModel <- S.CARbym(formula=form, family="binomial", trials=size,
