...
`r colFmt('Exercise 1.','blue')`  Conduct simlation experiments to determine how sample size and number of response variables affects estimates of the coefficients and covariance matrix
